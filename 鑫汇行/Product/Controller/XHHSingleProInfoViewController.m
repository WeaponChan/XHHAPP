//
//  XHHSingleProInfoViewController.m
//  鑫汇行
//
...
@interface XHHSingleProInfoViewController ()<UIWebViewDelegate>{
    NSString *pro_id;
}
@property (nonatomic,strong)UIWebView *webView;
@end

@implementation XHHSingleProInfoViewController
...
-(void)setupView{
    ...
    [LhkhHttpsManager requestWithURLString:url parameters:nil type:1 success:^(id responseObject) {
        NSString *url = responseObject[@"list"][@"pro_material"];
