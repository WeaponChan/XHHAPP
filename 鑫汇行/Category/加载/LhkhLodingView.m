...
static LhkhLodingView *loadView;
...
{
    loadView = [[LhkhLodingView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height) type:LoadingViewDot];
...
+ (void)showLineView:(UIView *)view
{
    ...
    loadView = [[LhkhLodingView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height) type:LoadingViewLine];
    loadView.backgroundColor = [UIColor whiteColor];
    loadView.center = view.center;
    [view addSubview:loadView];
}
...
+ (void)showCircleView:(UIView *)view
{
    ...
    loadView = [[LhkhLodingView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height) type:LoadingViewCircle];
    loadView.backgroundColor = [UIColor whiteColor];
    loadView.center = view.center;
    [view addSubview:loadView];
...
{
    loadView = [[LhkhLodingView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height) type:LoadingViewCircleJoin];
    loadView.backgroundColor = [UIColor whiteColor];
    loadView.center = view.center;
    [view addSubview:loadView];
...

{
    ...
    replicatorLayer.cornerRadius    = 10.0;
    replicatorLayer.position        =  self.center;
    replicatorLayer.backgroundColor = [UIColor colorWithRed:236/255.f green:236/255.f blue:236/255.f alpha:0].CGColor;
    ...
    dot.bounds          = CGRectMake(0, 0, 10, 10);
    dot.position        = CGPointMake(50, 20);
    dot.backgroundColor = [UIColor colorWithRed:0.6 green:0.6 blue:0.6 alpha:0.5].CGColor;
    dot.cornerRadius    = 5;
    dot.masksToBounds   = YES;
