//
//  XHHZhengxindianViewController.m
//  鑫汇行
//
...
#import "WXApi.h"
@interface XHHZhengxindianViewController ()<UIWebViewDelegate,JSObjectDelegate,MFMessageComposeViewControllerDelegate,WXDelegate>{
...
@implementation XHHZhengxindianViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = @"征信点";
